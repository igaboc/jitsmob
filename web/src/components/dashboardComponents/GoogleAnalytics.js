  ...
  return (
    ...
    <div>
      ...
      <div className='report-card'>
        ...
        <h6 className='text-muted'><i>Last 30 Days</i></h6>
      ...
      <div className='report-card'>
        <h3 className='text-muted'>Page Views</h3>
        <h6 className='text-muted'><i>Last 30 Days</i></h6>
        <iframe width="600" height="202" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRhCnArB4jO01TalnpJhJOOjRKfJMPuS7rFt43OvLhq52te4oodCDJkogj1YEZElXr0VAOM02yN7Xql/pubchart?oid=424405174&amp;format=interactive"></iframe>
      </div>
