  ...
  <Fragment>
    ...
    <div className="topnav row py-2" id="myTopnav">
      ...
      <div className="col-10 col-lg-9 pr-5">
        <a className="ml-4 pt-3 pb-2" href="#news">News</a>
        <a className="mx-4 pt-3 pb-2" href="#contact">Contact</a>
        <a className="mx-4 pt-3 pb-2" href="#about">About</a>
        <a className="mr-4 pt-3 pb-2 active" href="#home">Home</a>
