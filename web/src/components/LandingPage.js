...
function LandingPage({
  ...
  return (
    <div>
      <p>Jitsmob logo</p>
      <img className="55555" src="http://placeholder.pics/svg/100x100" style={{ textAlign: 'left' }} />

      <p>Find out more (module? fixed scrolling)</p>
    </div>
    ...
    //   <img src="http://placeholder.pics/svg/100x100" />
